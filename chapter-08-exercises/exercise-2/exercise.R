...
num_list <- lapply(num_list, round)
paste(num_list)
...
sentence <- tolower("Oh, the moon! Pales in comparison to you and I don't know what I should do")
